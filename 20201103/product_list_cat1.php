...
//判斷式
$sql = "SELECT products. *, category.name AS category_name FROM products JOIN category ON products.category_id = category.id WHERE products.valid=1 AND products.category_id=$category
